...
| --- | --- | --- | --- |
| SRC-1 | `docs/composable-agent-workflow-design.md` | Current R3 design authority, status In Review on 2026-04-30, decision requested `Approve with heightened controls`. | Defines the intended control plane: versioned recipes, pinned snapshots, execution profiles, durable queue items, Temporal decision Updates, read-only triage, worktree containment, compact artifacts, visibility/projection controls, replay/versioning gates, and heightened controls. Implementation cannot start until approval is recorded. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SRC-1 / OBJ-1 / Critical path | SURF-1, SURF-3, SURF-4 | PKG-1, PKG-3, PKG-4, PKG-5 | WP-1, WP-3, WP-5 | MS-1, MS-4 | CTRL-1, CTRL-2, CTRL-8 | VAL-1, VAL-3, VAL-8, VAL-17, VAL-18 | REV-1, REV-3 | REL-1, OBS-1, OBS-8 | EVD-1, EVD-3, EVD-8, EVD-17, EVD-18 |
